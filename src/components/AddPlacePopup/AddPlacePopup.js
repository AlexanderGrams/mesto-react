...
function AddPlacePopup({isOpen, onClose, onAddCrad}) {
  const {values, inputValidity, inputValidationMessage, handleChange, setValues, setInputValidity} = useForm({});
  ...
  return (
    <PopupWithForm isSubmitDisabled={isSubmitDisabled} onSubmit={handleAddPlaceSubmit} name={'add-card'} title={'Новое место'} isOpen={isOpen} onClose={onClose} buttonText="Сохранить">
